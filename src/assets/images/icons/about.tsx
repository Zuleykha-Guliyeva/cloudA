...
export const AboutIcon4 = () => {
  return (
    ...
    >
      ...
      />
      <path
        d='M16.7101 18.5902C17.5882 18.5902 18.3001 17.8783 18.3001 17.0002C18.3001 16.122 17.5882 15.4102 16.7101 15.4102C15.832 15.4102 15.1201 16.122 15.1201 17.0002C15.1201 17.8783 15.832 18.5902 16.7101 18.5902Z'
        stroke='#2BAAE2'
        strokeWidth='1.5'
        stroke-miterlimit='10'
        strokeLinecap='round'
